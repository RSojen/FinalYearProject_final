...
#code taken from https://github.com/MIT-SPARK/Kimera-PGMO/blob/39ea32779ffbef23a34871e85b8bf4f384a86c00/scripts/plot_dgrf.py

def read_node_line(line_str):
    entries = line_str.split()
    return entries[1], [float(entries[2]), float(entries[3]), float(entries[4])]
